          ...
          <div className="eth price container">
            ...
            <div className="reccomendation container">
              <ul className="reccomendation list">
                <li>
                  {/*<span className="recText">The best buy price for ETH is with</span>{bestPrice("buy", "eth")}*/}
                </li>
                <li>
                  {/*<span className="recText">The best sell price for ETH is with</span>{bestPrice("sell", "eth")}*/}
                </li>
              </ul>
            </div>
          </div>
